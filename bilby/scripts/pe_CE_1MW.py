...
frequencies_asd, strain_asd = np.loadtxt('/ligo/home/ligo.org/pratyusava.baral/dispersion/asd/CE40km_1p0MW_aLIGO_coat_strain.txt', unpack=True)
...
if options.CE20:
    frequencies_asd, strain_asd = np.loadtxt('/ligo/home/ligo.org/pratyusava.baral/dispersion/asd/CE20km_1p0MW_aLIGO_coat_strain.txt', unpack=True)
